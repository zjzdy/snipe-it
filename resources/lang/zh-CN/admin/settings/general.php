...
return array(
  ...
  'default_language'			=> '默认语言',
	'default_eula_help_text'	=> '你也可以将自定义的EULA与特定资产类别相关联。',
    ...
    'update_general_settings'        => '修改一般设置',
    'update_alert_settings'        => '修改警告设置',
    'oauth_api_settings'        => 'OAuth API设置',
    'update_asset_tag_settings'        => '修改资产标签设置',
    'update_barcode_settings'        => '修改条形码设置',
    'update_branding_settings'        => '修改标识设置',
    'update_label_settings'        => '修改标签设置',
    'update_ldap_settings'        => '修改LDAP/AD设置',
    'update_localization_settings'        => '修改语言设置',
    'php_info'        => 'PHP信息',
    'purge_deleted'        => '清空数据',
    'update_security_settings'        => '修改安全设置',
    'update_slack_settings'        => '修改Slack设置',
    'branding'        => '条形码',
    'add_your_custom_css'        => '添加自定义CSS',
    'optional_footer_text'        => '可选页脚',
    'enabled'        => '启用',
    'disabled'        => '禁用',
    'superadmin_only'        => '仅限超级管理员',
    'text'        => '文本',
    'logo_with_text'        => '文本与Logo',
    'test_mail'        => '测试邮箱',
    'send_test_mail'        => '发送测试邮件',
    'test_mail_help'        => '将尝试发送测试邮件到',
    'file'        => '文件',
    'created'        => '创建时间',
    'size'        => '大小',
    'backup_locate_text'        => '备份文件将保存在: ',
    'require_one_letter'        => '要求至少一个字母',
    'require_one_number'        => '要求至少一个数字',
    'require_one_symbol'        => '要求至少一个标点符号',
    'require_one_uppercase_lowercase'        => '要求至少一个大写字母与小写字母',
    'alert_email_help'        => '发送警报的目标电子邮件地址或通讯组列表，以逗号分隔',
    'qr_text_placeholder'        => '您公司的财产',
    'qr_text_title'        => '您想要在标签上显示的其余文本',
    'brand_help'        => 'Logo, 站点名称',
    'general_settings_help'        => '默认EULA以及其他',
    'security'        => '安全',
    ...
    'slack_help'        => 'Slack设置',
    'asset_tags'        => '资产标签',
    'asset_tags_help'        => '增长规则与前缀',
    'barcodes'        => '条形码',
    'barcodes_help'        => '条形码与二维码设置',
    'labels'        => '标签',
    'labels_help'        => '标签大小与设置',
    'ldap'        => 'LDAP',
    'ldap_help'        => 'LDAP/Active Directory活动目录',
    'backups'        => '备份',
    'backups_help'        => '下载文件与数据',
    'oauth'        => 'OAuth',
    'oauth_help'        => 'Oauth节点设置',
    'phpinfo'        => 'PHP',
