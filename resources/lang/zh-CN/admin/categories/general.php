...
return array(
    'about_categories_title' 			=> '关于资产类别',
    'about_categories'  				=> '资产类别将帮助你管理你的资产。你可以设置例如：台式机，笔记本，手机，平板 等等类别，当然你也可以自定义这些类别。',
    ...
    'create'  							=> '创建类别',
    'edit'                              => '编辑类别',
    'eula_text'							=> '资产类别的最终用户许可协议',
    'eula_text_help'					=> '此字段允许您为特定资产类别自定义的EULA（最终用户许可协议）。如果您所有资产只有一个EULA（最终用户许可协议），你可以检查下面的框中使用默认设置。',
    'name'                              => '类别名称',
    'require_acceptance'				=> '要求用户确认接受这一类的资产。',
    'required_acceptance'				=> '用户会收到一封邮件，邮件中包含一个确认接收的链接。',
    'required_eula'						=> '用户将收到关于EULA（最终用户许可协议）的邮件。',
    'no_default_eula'					=> '未找到默认的EULA（最终用户许可协议），请在设置中添加一个。',
    'update'  							=> '更新类别',
